...
class LedgerWidgetProvider : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            views.setTextViewText(R.id.ledger_net_balance, prefs.getString("ledger_net_balance", "Ã¢â€šÂ¹0.00"))
            views.setTextViewText(R.id.ledger_you_get, prefs.getString("ledger_you_get", "Ã¢â€šÂ¹0.00"))
            views.setTextViewText(R.id.ledger_you_owe, prefs.getString("ledger_you_owe", "Ã¢â€šÂ¹0.00"))
